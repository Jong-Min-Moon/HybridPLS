...
kidney_obj <- read_fd_kidney(
  training_ratio = 0.7,
  n_basis = 20,
  normalize = list("curve" = FALSE, "scalar"= TRUE, "between" = TRUE)
)
...
plot(L_trend_0_logit[1:L_max], main =" scalar + between scaling", ylab = "MSE", xlab = "number of iteration", pch=".", ylim=y_limit)
lines(L_trend_0_logit)
min_mse[5] <- min(L_trend_0_logit, omit.NA = TRUE)
